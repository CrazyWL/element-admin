    ...
    >
      ...
      <el-table-column label="操作" width="220px" align="center">
        <template slot-scope="">
          ...
          <el-button size="mini" type="success" @click="open">
            同意
          </el-button>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        <el-form-item label="请假类型" prop="type">
          <el-select v-model="person.education" disabled class="filter-item" placeholder="请假类型">
        ...
        <el-form-item label="时间" prop="title">
          <el-input disabled value="8" />
        </el-form-item>
        <el-form-item label="时间" prop="title">
          <el-input disabled :autosize="{ minRows: 2, maxRows: 4}" type="textarea" value="个人有事" />
        </el-form-item>
