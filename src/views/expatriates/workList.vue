<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-collapse accordion>
        <el-collapse-item>
          ...
          <el-select v-model="listQuery.type" placeholder="岗位" clearable class="filter-item" style="width: 240px">
          ...
          <el-input v-model="listQuery.title" placeholder="任务名称" style="width: 150px;" class="filter-item" @keyup.enter.native="handleFilter" />
    ...
    >
      ...
      <el-table-column label="任务类型" width="120px" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="申请工时" align="center">
        <template slot-scope="scope">
...
export default {
  ...
  data() {
    return {
      ...
      importanceOptions: ['功能开发', 'UI设计'],
      educationOptions: ['研究生', '本科', '大专'],
      statusOptions: ['已评估', '待评估'],
