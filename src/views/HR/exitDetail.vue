<template>
  <div class="tab-container">
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="6"><div class="grid-content bg-purple">合作部门</div></el-col>
      ...
      <el-col :span="6"><div class="grid-content bg-purple">项目名称</div></el-col>
    ...
    <el-row :gutter="20">
      <el-col :span="6"><div class="grid-content bg-purple">管理研发处意见</div></el-col>
      <el-col :span="18"><div class="grid-content">
