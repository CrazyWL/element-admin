<template>
  <div class="app-container">
    <div class="block">
      <el-select v-model="listQuery.importance" placeholder="考勤状态" clearable style="width: 120px" class="filter-item">
    ...
    >
      ...
      <el-table-column align="center" label="操作时间" width="95">
        <template>
          <span>08:34:51</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="班次类型" width="120px" align="center">
        <template slot-scope="">
          股份大楼
        </template>
      </el-table-column>
