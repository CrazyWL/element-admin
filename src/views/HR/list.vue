<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-collapse accordion>
        <el-collapse-item>
          ...
          <el-input v-model="listQuery.title" placeholder="工作地点" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
    ...
    >
      ...
      <el-table-column label="管理部门" width="100px" align="center">
        <template slot-scope="">
          中台研发处
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" width="140px" align="center">
        <template slot-scope="">
          ...
          <router-link :to="{ path:'/supplier/tab'}">
