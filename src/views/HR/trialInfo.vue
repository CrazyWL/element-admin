<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-collapse accordion>
        <el-collapse-item>
          ...
          <el-select v-model="listQuery.status" placeholder="考核结果" clearable style="width: 160px" class="filter-item">
    ...
    >
      ...
      <el-table-column label="考核日期" align="center">
        <template slot-scope="scope">

          <span>{{ scope.row.sqrq }}</span>
        </template>
      </el-table-column>
      <el-table-column label="考核结果" width="100px" align="center">
        <template slot-scope="scope">
