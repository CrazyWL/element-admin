<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-collapse accordion>
        <el-collapse-item>
          ...
          <el-input v-model="listQuery.title" placeholder="岗位" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
          <el-input v-model="listQuery.title" placeholder="级别" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
          <el-input v-model="listQuery.title" placeholder="学历" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
          <el-input v-model="listQuery.title" placeholder="工作年限" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
          <!-- <el-input v-model="listQuery.title" placeholder="状态" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" /> -->
          <el-input v-model="listQuery.title" placeholder="批次" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
    ...
    >
      ...
      <el-table-column label="毕业院校" width="110px" align="center">
        <template slot-scope="">
          华南理工大学
        </template>
      </el-table-column> -->
      ...
      <el-table-column label="工作年限" width="100px" align="center">
        <template slot-scope="">
          3
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" width="300px" align="center">
        <template slot-scope="">
          ...
          <router-link to="checkManage">
            <el-button size="mini" type="warning">
              查看考勤
            </el-button>
          </router-link>
          <!-- <router-link :to="{ path:'/example/tab', query: {role: 2} }">
